...
pub const BUILTIN_MATERIAL_WINDOW_DARK_GASKET: &str = "builtin.window.dark_gasket";
pub const BUILTIN_MATERIAL_WINDOW_WHITE_FRAME: &str = "builtin.window.white_frame";
pub const BUILTIN_MATERIAL_WINDOW_HARDWARE_STEEL: &str = "builtin.window.hardware_steel";
...
pub fn ensure_builtin_materials(registry: &mut MaterialRegistry) {
    ...
    registry.upsert(MaterialDef {
        id: BUILTIN_MATERIAL_WINDOW_WHITE_FRAME.to_string(),
        name: "Window White Painted Frame".to_string(),
        base_color: [0.96, 0.965, 0.94, 1.0],
        perceptual_roughness: 0.36,
        metallic: 0.0,
        reflectance: 0.58,
        specular_tint: [1.0, 0.98, 0.94],
        emissive: [0.0, 0.0, 0.0],
        emissive_exposure_weight: 1.0,
        diffuse_transmission: 0.0,
        specular_transmission: 0.0,
    ...
    registry.upsert(MaterialDef {
        id: BUILTIN_MATERIAL_WINDOW_DARK_GASKET.to_string(),
        name: "Window Dark Rubber Gasket".to_string(),
    ...
    registry.upsert(MaterialDef {
        id: BUILTIN_MATERIAL_WINDOW_HARDWARE_STEEL.to_string(),
        name: "Window Brushed Steel Hardware".to_string(),
        base_color: [0.62, 0.64, 0.63, 1.0],
        perceptual_roughness: 0.28,
        metallic: 1.0,
        reflectance: 0.5,
        specular_tint: [0.95, 0.96, 0.95],
        emissive: [0.0, 0.0, 0.0],
        emissive_exposure_weight: 1.0,
        diffuse_transmission: 0.0,
        specular_transmission: 0.0,
