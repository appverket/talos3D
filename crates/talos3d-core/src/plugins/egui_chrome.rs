    ...
    egui::Window::new("Renderer")
        ...
        .show(ctx, |ui| {
            ...
            ui.collapsing("Drawing Views", |ui| {
                ...
                ui.label(
                    egui::RichText::new(
                        "X-Ray swaps scene materials to simple texture-free translucent surfaces. Paper fill swaps scene materials to white unlit surfaces. Outline is depth-tested visible-edge linework; Wireframe shows full linework.",
                    )
                    .small()
                    .color(CHROME_MUTED),
                );
