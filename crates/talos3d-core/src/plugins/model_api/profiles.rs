...
pub(super) const TOOL_CATEGORIES: &[(&str, ToolCategory)] = &[
    ...
    ("boolean_difference", ToolCategory::ModelingExtended),
    ("boolean_intersection", ToolCategory::ModelingExtended),
    ("boolean_union", ToolCategory::ModelingExtended),
    ...
    ("create_assembly", ToolCategory::ModelingExtended),
    ("get_assembly", ToolCategory::ModelingExtended),
    ("list_assemblies", ToolCategory::ModelingExtended),
    ("list_assembly_members", ToolCategory::ModelingExtended),
