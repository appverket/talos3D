...
and `place_dimension_line` creates measured annotations from start and end
points plus an explicit visible line placement (`line_point` or scalar
`offset`), with optional extension and unit overrides.
