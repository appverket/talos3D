...
use talos3d_core::curation::CurationPlugin;
#[cfg(feature = "model-api")]
...
use talos3d_core::plugins::{
    ...
    recipe_drafts::RecipeDraftPlugin,
    render_pipeline::RenderPipelinePlugin,
    selection::SelectionPlugin,
    session_draft_cache::SessionDraftCachePlugin,
...
fn main() {
    ...
    .add_plugins(CorpusGapPlugin)
    .add_plugins(RecipeDraftPlugin)
    .add_plugins(talos3d_core::plugins::assembly_pattern_drafts::AssemblyPatternDraftPlugin)
    .add_plugins(SessionDraftCachePlugin)
    .add_plugins(CurationPlugin);
